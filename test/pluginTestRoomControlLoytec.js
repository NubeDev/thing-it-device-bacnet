...
describe('[thing-it] BACnet Device', function () {
    ...
    before(function () {
        ...
        testDriver.registerUnitPlugin(__dirname + "/../default-units/roomControl");
        testDriver.start({
            configuration: require("../examples/configurationLoytec.js"),
            heartbeat: 10
        });
    ...
    describe('room control', function () {
        describe('#start', function () {
            ...
            it('should have received initial value via COV subscription for setpoint and temperature',
                function (done) {
                    setTimeout(function () {
                        var currentState = testDriver.LoytecBACnet.roomControl1.getState();
        ...
        describe('#incrementSetpoint', function () {
            it('should increase the setpoint modification and the setpoint by 1',
                function (done) {
                    ...
                    testDriver.LoytecBACnet.roomControl1.incrementSetpoint()
                        .then(function () {
                            var resultingState = testDriver.LoytecBACnet.roomControl1.getState();
        ...
        describe('#decrementSetpoint twice', function () {
            ...
            it('should decrease the setpoint modification and the setpoint by 2',
                function (done) {
                    ...
                    testDriver.LoytecBACnet.roomControl1.decrementSetpoint()
                        .then(function () {
                            return testDriver.LoytecBACnet.roomControl1.decrementSetpoint();
                        })
                        .then(function () {
                            var resultingState = testDriver.LoytecBACnet.roomControl1.getState();
                            assert.equal(resultingState.setpoint, desiredState.setpoint);
        ...
        describe('#setState', function () {
            ...
            it('should set the device back to the initial state',
                function (done) {
                    ...
                    testDriver.LoytecBACnet.roomControl1.setState(desiredState)
                        .then(function () {
                            var resultingState = testDriver.LoytecBACnet.roomControl1.getState();
                            assert.equal(resultingState.setpoint, desiredState.setpoint);
